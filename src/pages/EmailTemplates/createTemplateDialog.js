              ...
              return (
                <Dialog.Root open={isOpen} modal={true} onOpenChange={setIsOpen}>
                  <Dialog.Trigger asChild>
                    <button className="bg-stone-900 text-white flex flex-row justify-center items-center gap-1.5 hover:bg-stone-700 px-3 py-2.5 rounded font-medium text-sm">
                      Create New Template
                    </button>
                  </Dialog.Trigger>
                  <Dialog.Portal>
